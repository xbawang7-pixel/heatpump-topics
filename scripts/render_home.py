...
<style>{BASE_CSS}
  ...
  .board-card-title {{ font-size: 23px; font-weight: 600; color: var(--text); font-family: Georgia, "Songti SC", serif; }}
  .board-card-desc {{ font-size: 16px; color: var(--text-muted); margin-top: 6px; }}
  .board-card-stats {{ margin-top: 16px; display: flex; gap: 12px; font-size: 15px; color: var(--text-muted); }}
